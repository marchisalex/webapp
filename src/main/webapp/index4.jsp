...
<div class="jumbotron">
    <div class="container">
        ...
        <p></p>
        <img class="image" src="old.jpg" width="100%" height="550px"></img>
    </div>
</div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <h2></h2>
            <p></p>
            <p><a class="btn btn-default" href="https://www.porsche.com/central-eastern-europe/en/_romania_/modelstart/all/?modelrange=panamera" role="button">Build Your Own &raquo;</a></p>
        </div>
        <div class="col-md-4">
            <h2></h2>
            <p> </p>
